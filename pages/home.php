...
<section id="presentation">
    <div class="container">    
        ...
        <div class="row bg-light shadow">
            <div class="col-md-8 col-sm-8 text-light bg-primary rounded-left">
                <h1>Contabilidade</h1>
                <p>Certificação</p>
                <p>Impressão</p>
            </div>
            <div class="col-md-4 col-sm-4 rounded-right ">
                <img src="../img/pexels-anna-nekrashevich-6801648.jpg" alt="" width="100%">
            </div>
        </div>
...
<section id="services" class="container">
    <h2 class="text-center text-dark"> <u>Serviços</u> </h2>
    <div>
        <div class="row" style="margin-top: 20px;">
            <div class="col-md-5 bg-primary shadow  rounded">
